...
from netanal.ml_features import FeatureExtractor
from netanal.live_detection import LiveAnomalyDetector
if TYPE_CHECKING:
...
class CaptureEngine:
    ...
    def __init__(
        ...
        self._detector = LiveAnomalyDetector()
    ...
    def _process_packets(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                extracted = self._extractor.extract_features(info)

                features = self._extractor.to_dict(extracted)

                # ---------------------------------------------------
                # ML anomaly detection
                # ---------------------------------------------------

                prediction, score = self._detector.predict(
                    features
                )
